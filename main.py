...
def run_game(level):
    ...
    while run:
        ...
        if countdown > 0:
            ...
            increase_value = gv.alien_max_increase - gv.alien_max_increase * len(alien_group) / (gv.alien_rows * gv.alien_cols)
            alien_move_speed = gv.alien_move_speed + increase_value
            ...
            alien_group.update(
                ...
                alien_move_speed=alien_move_speed,
            )
            bullet_group.update()
